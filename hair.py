...
def process_brand_type(brand_type):
    translation_map = {
        "Haarserum": "Сыворотка для волос",
        "Leave-in-Treatment": "Несмываемое лечение",
        "Haarshampoo": "Шампунь для волос",
        "Haarmaske": "Маска для волос",
        "Haarpaste": "Паста для волос",
        "Glätteisen": "Выпрямитель",
        "Haarstylingset": "Набор для укладки волос",
        "Conditioner": "Кондиционер",
        "Haarlotion": "Лосьон для волос",
        "Haarspray": "Лак для волос",
        "Haaröl": "Масло для волос",
        "Haarkur": "Лечение волос",
        "Hitzeschutzspray": "Термозащитный спрей",
        "Spray-Conditioner": "Спрей-кондиционер",
        "Haarpuder": "Пудра для волос",
        "Farbmaske": "Цветная маска",
        "Warmluftbürste": "Щетка для горячего воздуха",
        "Haarpflegeset": "Набор для ухода за волосами",
        "Haarfarbe": "Цвет волос",
        "Set": "Набор",
        "Professionelle Haartönung": "Профессиональное окрашивание волос",
        "Föhnlotion": "Лосьон для сушки феном",
        "Ansatzspray": "Спрей для крепления",
        "Haartrockner": "Фен",
        "Schaumfestiger": "Пенообразующее вещество",
        "Haarwachs": "Воск для волос",
        "Welleneisen": "Волновой утюг",
        "Trockenshampoo": "Сухой шампунь",
        "Paddlebürste": "Расчёска",
        "No Tangle Bürste": "Расчёска",
        "Texturizing Spray": "Текстурирующий спрей",
        "Kopfhautpflege": "Уход за кожей головы",
        "Stylinglotion": "Лосьон для укладки",
        "Stylinglotion": "Лосьон для укладки",
        "Lockenstab": "Щипцы для завивки"
    }
...
async def main():
    try:
        ...
        driver.get('https://www.flaconi.at/haarpflege/')
        time.sleep(5)
                ...
                if photos:
                    ...
                    if sizes and prices:
                        data.append({
                            ...
                            'Price': '',
                            'Parent UID': '',
                            'Category': f"Уход за волосами;{brand_type};",
        ...
        filename = f'Hair_{current_time}.xlsx'
